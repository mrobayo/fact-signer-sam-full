...
public class FirmasGenericasXAdES extends FirmaGenerica {
    ...
    public void ejecutarFirmaXades(String pathArchivoXMLFirmar, String pathDirectorioSalida, String nombreArchivoFirmado, Provider provider, X509Certificate certificado, PrivateKey privateKey) throws ParserConfigurationException, SAXException, IOException {
    ...
    protected DataToSign createDataToSign() throws ParserConfigurationException, SAXException, IOException {
        ...
        Document docToSign = this.getDocument(this.archivoAFirmar);
