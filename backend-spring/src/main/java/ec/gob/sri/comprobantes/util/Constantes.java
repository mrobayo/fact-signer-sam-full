...
public class Constantes {
    ...
    public static final String ACTUALIZAR_DESC_IMPUESTO_VALOR = "resources/actualizarEstructuras/actualizarColumnaIDESC_MPUESTO_VALOR.sql";
    ...
    public static final String ACTUALIZAR_COLUMNA_RIMPE_AGENTE = "resources/actualizarEstructuras/agregarColumnasRIMPE_AGENTE_RETENCION.sql";
    ...
    public static final Integer LONGITUD_CLAVE_PREAUTORIZADA = 8;
