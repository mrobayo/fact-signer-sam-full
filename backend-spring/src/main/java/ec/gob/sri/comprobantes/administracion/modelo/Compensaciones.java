...
public class Compensaciones {
    ...
    public double getTarifaDouble() {
        return (double)this.tarifaCompensacion;
    }
    ...
    public String toString() {
        return this.getCodigoCompensacion() != 0 ? this.getCodigoCompensacion() + " - " + this.getTipoCompensacion() + " - " + this.getTarifaDouble() + "%" : "Seleccione....";
    }
}
