...
public class ImpuestoValor {
    ...
    public String toString() {
        if (this.codigoImpuesto != 1 && this.codigoImpuesto != 2 && this.codigoImpuesto != 3 && this.codigoImpuesto != 5 || !this.tipoImpuesto.equals("R") && !this.tipoImpuesto.equals("I") && !this.tipoImpuesto.equals("A") && !this.tipoImpuesto.equals("B")) {
            return null;
        } else {
