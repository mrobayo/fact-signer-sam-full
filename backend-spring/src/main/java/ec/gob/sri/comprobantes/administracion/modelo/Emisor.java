...
public class Emisor {
    ...
    private String regimenRegimenRIMPE;
    ...
    public String getRegimenRIMPE() {
        return this.regimenRegimenRIMPE;
    }

    public void setRegimenRIMPE(String regimenRegimenRIMPE) {
        this.regimenRegimenRIMPE = regimenRegimenRIMPE;
    }
}
