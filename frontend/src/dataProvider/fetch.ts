 ...
 */
export const fetchJson = (url: RequestInfo | URL, options: Options = {}) => {
...
const isValidObject = (value: unknown): value is {[key: string]:any} => {
    if (!value) {
        return false;
    }
...
export const flattenObject = (value: any, path: string[] = []): {[key: string]: any} => {
