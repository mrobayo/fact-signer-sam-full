                ...
                })),
        {
            ...
            getNextPageParam: lastLoadedPage => {
                if (lastLoadedPage.pageInfo) {
                    return lastLoadedPage.pageInfo.hasNextPage && lastLoadedPage.pageParam
                ...
                return lastLoadedPage.pageParam && lastLoadedPage.pageParam < totalPages
                    ? Number(lastLoadedPage.pageParam) + 1
                    : undefined;
            },
            getPreviousPageParam: lastLoadedPage => {
                if (lastLoadedPage.pageInfo) {
                    return lastLoadedPage.pageInfo.hasPreviousPage && lastLoadedPage.pageParam
                        ? lastLoadedPage.pageParam - 1
                        : undefined;
                }
                ...
                return lastLoadedPage.pageParam === 1
                    ? undefined
                    : (lastLoadedPage.pageParam && lastLoadedPage.pageParam - 1);
            },
        }
    );
